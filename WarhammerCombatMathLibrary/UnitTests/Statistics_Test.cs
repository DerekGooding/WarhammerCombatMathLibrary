...
public sealed class Statistics_Test
{
    ...
    /// </summary>
    [TestMethod]
    public void ProbabilityOfSuccess_NumberOfPossibleResultsLessThanOrEqualTo0() => Assert.AreEqual(0, Statistics.GetProbabilityOfSuccess(-1, 0));

    /// <summary>
    /// Tests the case where the numberOfSuccessfulResults argument is out of range.
    /// </summary>
    [TestMethod]
    public void ProbabilityOfSuccess_NumberOfSuccessfulResultsLessThanOrEqualTo0() => Assert.AreEqual(0, Statistics.GetProbabilityOfSuccess(1, -1));

    /// <summary>
    /// Tests the case where the numberOfSuccessfulResults argument is greater than the numberOfPossibleResults argument.
    /// </summary>
    [TestMethod]
    public void ProbabilityOfSuccess_SuccessfulResultsGreaterThanPossibleResults() => Assert.AreEqual(1, Statistics.GetProbabilityOfSuccess(1, 2));

    /// <summary>
    /// Tests the ProbabilityOfSuccess() method with given parameters.
    /// </summary>
    [TestMethod]
    public void ProbabilityOfSuccess_TestParams1() => Assert.AreEqual(0.5, Statistics.GetProbabilityOfSuccess(2, 1));

    /// <summary>
    /// Tests the ProbabilityOfSuccess() method with given parameters.
    /// </summary>
    [TestMethod]
    public void ProbabilityOfSuccess_TestParams2() => Assert.AreEqual(0.25, Statistics.GetProbabilityOfSuccess(4, 1));

    /// <summary>
    /// Tests the ProbabilityOfSuccess() method with given parameters.
    /// </summary>
    [TestMethod]
    public void ProbabilityOfSuccess_TestParams3() => Assert.AreEqual(0.7, Statistics.GetProbabilityOfSuccess(10, 7));
    ...
    /// </summary>
    [TestMethod]
    public void Mean_NumberOfTrialsLessThan1() => Assert.AreEqual(0, Statistics.GetMeanOfDistribution(0, 1));

    /// <summary>
    /// Tests the case where the probability is less than 0.
    /// </summary>
    [TestMethod]
    public void Mean_ProbabilityLessThan0() => Assert.AreEqual(0, Statistics.GetMeanOfDistribution(1, -1));

    /// <summary>
    /// Tests the method with given parameters.
    /// </summary>
    [TestMethod]
    public void Mean_TestParams1() => Assert.AreEqual(0.5, Statistics.GetMeanOfDistribution(1, 0.5));

    /// <summary>
    /// Tests the method with given parameters.
    /// </summary>
    [TestMethod]
    public void Mean_TestParams2() => Assert.AreEqual(5, Statistics.GetMeanOfDistribution(10, 0.5));

    /// <summary>
    /// Tests the method with given parameters.
    /// </summary>
    [TestMethod]
    public void Mean_TestParams3() => Assert.AreEqual(25, Statistics.GetMeanOfDistribution(100, 0.25));
    ...
    /// </summary>
    [TestMethod]
    public void StandardDeviation_NumberOfTrialsLessThan1() => Assert.AreEqual(0, Statistics.GetStandardDeviationOfDistribution(0, 1));

    /// <summary>
    /// Tests the case where the probability is less than 0.
    /// </summary>
    [TestMethod]
    public void StandardDeviation_ProbabilityLessThan0() => Assert.AreEqual(0, Statistics.GetStandardDeviationOfDistribution(1, -1));

    /// <summary>
    /// Tests the method with given parameters.
    /// </summary>
    [TestMethod]
    public void StandardDeviation_TestParams1() => Assert.AreEqual(0.5, Statistics.GetMeanOfDistribution(1, 0.5));

    /// <summary>
    /// Tests the method with given parameters.
    /// </summary>
    [TestMethod]
    public void StandardDeviation_TestParams2() => Assert.AreEqual(1.58, Math.Round(Statistics.GetStandardDeviationOfDistribution(10, 0.5), 2));

    /// <summary>
    /// Tests the method with given parameters.
    /// </summary>
    [TestMethod]
    public void StandardDeviation_TestParams3() => Assert.AreEqual(4.33, Math.Round(Statistics.GetStandardDeviationOfDistribution(100, 0.25), 2));
    ...
    /// </summary>
    [TestMethod]
    public void BinomialCoefficient_PopulationLessThan0() => Assert.AreEqual(0, Statistics.BinomialCoefficient(-1, 1));

    /// <summary>
    /// Tests the case where the combinationSize argument is out of range.
    /// </summary>
    [TestMethod]
    public void BinomialCoefficient_CombinationSizeLessThan0() => Assert.AreEqual(0, Statistics.BinomialCoefficient(1, -1));

    /// <summary>
    /// Tests the case where combinationSize is bigger than totalPopulation.
    /// </summary>
    [TestMethod]
    public void BinomialCoefficient_CombinationSizeBiggerThanTotalPopulation() => Assert.AreEqual(0, Statistics.BinomialCoefficient(1, 2));

    /// <summary>
    /// Tests the probability mass function with given inputs.
    /// </summary>
    [TestMethod]
    public void BinomialCoefficient_TestParams1() => Assert.AreEqual(1, Statistics.BinomialCoefficient(1, 1));

    /// <summary>
    /// Tests the probability mass function with given inputs.
    /// </summary>
    [TestMethod]
    public void BinomialCoefficient_TestParams2() => Assert.AreEqual(252, Statistics.BinomialCoefficient(10, 5));

    /// <summary>
    /// Tests the probability mass function with given large inputs.
    /// </summary>
    [TestMethod]
    public void BinomialCoefficient_TestBigParams() => Assert.AreEqual(BigInteger.Parse("18053528883775"), Statistics.BinomialCoefficient(50, 32));
    ...
    /// </summary>
    [TestMethod]
    public void ProbabilityOfMultipleSuccesses_ProbabilityLessThan0() => Assert.AreEqual(0, Statistics.ProbabilityOfMultipleSuccesses(-1, 1));

    /// <summary>
    /// Tests the case where the probability argument is greater than 1.
    /// </summary>
    [TestMethod]
    public void ProbabilityOfMultipleSuccesses_ProbabilityGreaterThan1() => Assert.AreEqual(1, Statistics.ProbabilityOfMultipleSuccesses(2, 1));

    /// <summary>
    /// Tests the case where the numberOfTrials argument is out of range.
    /// </summary>
    [TestMethod]
    public void ProbabilityOfMultipleSuccesses_NumberOfSuccessesLessThan0() => Assert.AreEqual(0, Statistics.ProbabilityOfMultipleSuccesses(0.5, -1));

    /// <summary>
    /// Tests the probability mass function with given large inputs.
    /// </summary>
    [TestMethod]
    public void ProbabilityOfMultipleSuccesses_TestParams1() => Assert.AreEqual(0.1, Statistics.ProbabilityOfMultipleSuccesses(0.1, 1));

    /// <summary>
    /// Tests the probability mass function with given inputs.
    /// </summary>
    [TestMethod]
    public void ProbabilityOfMultipleSuccesses_TestParams2() => Assert.AreEqual(0.25, Statistics.ProbabilityOfMultipleSuccesses(0.5, 2));

    /// <summary>
    /// Tests the probability mass function with given inputs.
    /// </summary>
    [TestMethod]
    public void ProbabilityOfMultipleSuccesses_TestParams3() => Assert.AreEqual(0.59, Math.Round(Statistics.ProbabilityOfMultipleSuccesses(0.9, 5), 2));
    ...
    /// </summary>
    [TestMethod]
    public void ProbabilityMassFunction_NumberOfTrialsLessThan1() => Assert.AreEqual(0, Statistics.ProbabilityMassFunction(0, 1, 0.5));

    /// <summary>
    /// Tests the case where the numberOfSuccesses argument is out of range.
    /// </summary>
    [TestMethod]
    public void ProbabilityMassFunction_NumberOfSuccessesLessThan0() => Assert.AreEqual(0, Statistics.ProbabilityMassFunction(1, -1, 0.5));

    /// <summary>
    /// Tests the case where the number of successes is greater than the number of trials.
    /// </summary>
    [TestMethod]
    public void ProbabilityMassFunction_NumberOfSuccessesGreaterThanNumberOfTrials() => Assert.AreEqual(0, Statistics.ProbabilityMassFunction(1, 2, 0.5));

    /// <summary>
    /// Tests the case where the probability argument is negative.
    /// </summary>
    [TestMethod]
    public void ProbabilityMassFunction_ProbabilityLessThan0() => Assert.AreEqual(0, Statistics.ProbabilityMassFunction(1, 1, -1));

    /// <summary>
    /// Tests the case where the probability argument is greater than 1.
    /// </summary>
    [TestMethod]
    public void ProbabilityMassFunction_ProbabilityGreaterThan1() => Assert.AreEqual(1, Statistics.ProbabilityMassFunction(1, 1, 2));

    /// <summary>
    /// Tests the probability mass function with given inputs.
    /// </summary>
    [TestMethod]
    public void ProbabilityMassFunction_TestParams1() => Assert.AreEqual(0.5, Statistics.ProbabilityMassFunction(1, 1, 0.5));

    /// <summary>
    /// Tests the probability mass function with given inputs.
    /// </summary>
    [TestMethod]
    public void ProbabilityMassFunction_TestParams2() => Assert.AreEqual(0.0584, Math.Round(Statistics.ProbabilityMassFunction(10, 5, 0.25), 4));

    /// <summary>
    /// Tests the probability mass function with given large inputs.
    /// </summary>
    [TestMethod]
    public void ProbabilityMassFunction_BigParams() => Assert.AreEqual(0.0160, Math.Round(Statistics.ProbabilityMassFunction(50, 32, 0.5), 4));
    ...
    {
        var dist = Statistics.GetSurvivorDistribution(10, 0.5);
    ...
    {
        var dist = Statistics.GetSurvivorDistribution(1, 10, 0.5);
        var firstProb = dist[0].Probability;
        Assert.AreEqual(1.0, firstProb, 0.0001, $"First probability was {firstProb}, expected 1.0");
    }
    ...
    {
        var dist = Statistics.GetSurvivorDistribution(10, 0.5, 2, 3);
        var firstProb = dist[0].Probability;
        Assert.AreEqual(1.0, firstProb, 0.0001, $"First probability was {firstProb}, expected 1.0");
    }
    ...
    {
        var dist = Statistics.GetSurvivorDistribution(1, 10, 0.5, 2, 3);
        var firstProb = dist[0].Probability;
        Assert.AreEqual(1.0, firstProb, 0.0001, $"First probability was {firstProb}, expected 1.0");
    }
